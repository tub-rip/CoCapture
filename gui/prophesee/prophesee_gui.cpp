...
namespace rcg::gui::prophesee {
    ...
    PropheseeGui::PropheseeGui(const char* serial_number, int id) {
        // Camera
        ...
        // GUI
        GenerateTextureRGB8(&cd_frame_texture_id_, cd_frame_width_, cd_frame_height_);
    ...
    void PropheseeGui::Show(bool* show) {
        ...
        if(show_visualization_) {
            ...
            UpdateTextureRGB8(&cd_frame_texture_id_, cd_frame_.data, cd_frame_width_, cd_frame_height_);
        ...
        if(*(show)) {
            ...
            ImGui::SameLine();
            ImGui::BeginDisabled(is_started_);
            ...
            ImGui::BeginDisabled(is_started_ || !mode_selected_);
    ...
    void PropheseeGui::StartRecording(const char* output_dir) {
        ...
        prophesee_camera_->StartRecording(recording_dir.c_str());
    }

    void PropheseeGui::StopRecording() {
